...
var ENTER=13, SPACE=32, ESC=27, BACKSPACE=8, SHIFT=16, SWITCH=96, FINISH=9999, TELEX=1, VNI=2;
var $target=null, $cursor, $viMode=true, $initialized=false, $byPassKeypress=false, $logging=false, $isVietnamese, $showSingle=true, $preViMode=true, $showTip=false;
